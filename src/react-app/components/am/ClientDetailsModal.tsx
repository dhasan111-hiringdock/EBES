...
export default function ClientDetailsModal({ client, onClose }: ClientDetailsModalProps) {
  ...
  const totalInterviews = client.interview_1 + client.interview_2 + client.interview_3;
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="bg-slate-50 rounded-lg p-4 border border-slate-200">
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div className="text-center p-3 bg-white rounded-lg border border-slate-200">
                <p className="text-xs text-slate-600 mb-1">Level 3</p>
                <p className="text-2xl font-bold text-indigo-600">{client.interview_3}</p>
              </div>
            </div>
          </div>
