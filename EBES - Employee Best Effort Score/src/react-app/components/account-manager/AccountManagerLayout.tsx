...
import { Building2, Users, RefreshCw, BarChart3, Briefcase, UserCircle, Award, Target, LogOut } from "lucide-react";
...
export default function AccountManagerLayout({
  ...
  const navItems = [
    { path: "/am", icon: Briefcase, label: "Roles" },
    { path: "/am/performance", icon: Target, label: "Performance" },
    { path: "/am/analytics", icon: BarChart3, label: "Analytics" },
    { path: "/am/ebes-score", icon: Award, label: "EBES Score" },
        ...
        <header className="bg-white shadow-sm border-b border-slate-200 px-6 py-4">
          <div className="flex items-center justify-between">
            <h2 className="text-2xl font-bold text-slate-800">
              {navItems.find(item => item.path === location.pathname)?.label || "Roles"}
            </h2>
