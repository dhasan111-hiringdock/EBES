...
import { TrendingUp, TrendingDown, AlertCircle, CheckCircle, Target, Users, Award } from "lucide-react";
          ...
          <div className="flex items-center justify-between">
            <div>
              <div className="flex items-center gap-3 mb-2">
                ...
                <h3 className="text-2xl font-bold">Overall EBES Score</h3>
              </div>
              <p className="text-5xl font-bold mt-4">{ebesScore.score.toFixed(1)}</p>
